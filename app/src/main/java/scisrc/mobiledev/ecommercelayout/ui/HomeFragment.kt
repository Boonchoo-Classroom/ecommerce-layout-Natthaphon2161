...
class HomeFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        recommendedProducts.add(ProductModel("HondaCivic", "พลังความแรงที่เกินกว่าใครจะต้านทาน", 1039000.00, R.drawable.ic_pen))
        recommendedProducts.add(ProductModel("Nissan GTR", "เครื่องยนต์เบนซิน รหัส VR38DETT V6", 10700000.00, R.drawable.ic_ruler))
        recommendedProducts.add(ProductModel("MAZDA MX-5", "เทคโนโลยีความปลอดภัย", 3029000.00, R.drawable.ic_notebook))
        ...
        promotionsList.add(ProductModel("คูปองส่วนลด", "รับคูปองส่วนลด 500000 บาท", 10200000.00, R.drawable.bundle_a))
